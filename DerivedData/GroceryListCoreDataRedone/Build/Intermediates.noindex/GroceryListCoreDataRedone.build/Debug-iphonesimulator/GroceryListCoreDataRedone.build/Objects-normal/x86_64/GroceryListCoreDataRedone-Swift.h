...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GroceryListCoreDataRedone",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC25GroceryListCoreDataRedone11AppDelegate")
...
SWIFT_CLASS_NAMED("Grocery")
@interface Grocery : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface Grocery (SWIFT_EXTENSION(GroceryListCoreDataRedone))
...
SWIFT_CLASS("_TtC25GroceryListCoreDataRedone30GroceryListTableViewController")
@interface GroceryListTableViewController : UITableViewController
- (void)viewDidLoad;
- (IBAction)addAction:(UIBarButtonItem * _Nonnull)sender;
...
SWIFT_CLASS("_TtC25GroceryListCoreDataRedone13SceneDelegate")
...
SWIFT_CLASS("_TtC25GroceryListCoreDataRedone14ViewController")
